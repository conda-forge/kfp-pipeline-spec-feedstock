...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kfp-pipeline-spec-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15557&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kfp-pipeline-spec-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kfp-pipeline-spec` can be installed with:

```
conda install kfp-pipeline-spec
```

It is possible to list all of the versions of `kfp-pipeline-spec` available on your platform with:
